            ...
            <tbody>
              {
                vendors.map((vendor) =>
                {
                  ...
                  <tr>
                    ...
                    <td>{vendor.mobNo}</td>
                    <td>
                      <button type="button" onClick={()=> approve(vendor.vendorId)} className="btn btn-success">Approve</button>
                    </td>
                    <td>
                      <button type="button" onClick={()=> reject(vendor.vendorId)} className="btn btn-danger">Reject</button>
                    </td>
                  </tr>)
                })
              }
