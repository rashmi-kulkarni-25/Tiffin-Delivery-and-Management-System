...
function UpdatePlan() {
    ...
    const getPlanById = async(id) =>
    {
        debugger
        var planId = {"id":id}
        // const url = createaUrl('admin/getplanbyid')
    ...
    {
        debugger
        var planToUpdate = {"plan_id":planId, "name":plan, "description": description,
                    "price": price, "no_of_meals": noOfMeals}
        
        const url = createaUrl('admin/updateplan')
        axios.put(url, 
            {
                "plan_id": planId,
                "name": plan,
