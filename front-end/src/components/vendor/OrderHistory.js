...
function VendorOrderHistory() {
    ...
    const [order, setOrder] = useState({name:0, tiffin_name:"", quantity:0, 
      total_price:0.0, timestamp:""})
  ...
  const getMyOrders = () =>
  {
      ...
      const url = createaUrl('vendor/orderhistory')
...
<div className="col-md-6">
        ...
        <h2 style={{textAlign:'center', marginTop:'15px', padding:'10px'}}>Orders History</h2>
        </div>
