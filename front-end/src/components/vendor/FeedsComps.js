...
function FeedsComps() {
    ...
    const [feedback, setFeedback] = useState({name:0, tiffin_name:"", category:"", 
      description:"", status:""})
...
const getFeedbacks = ()=>
{
    debugger
      ...
      const url = createaUrl('vendor/feedbackcomplaints')
...
<div className="col-md-6">
        ...
        <h2 style={{textAlign:'center', marginTop:'15px', padding:'10px'}}>Feedbacks / Complaints</h2>
        </div>
