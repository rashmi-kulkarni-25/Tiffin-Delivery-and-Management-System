...
function MyTiffins() {
    ...
    const [tiffin, setTiffin] = useState({tiffin_id: 0, tiffin_name: "", description: "",
    ...
    const getMyTiffins = ()=>
    {
      ...
      const url = createaUrl('vendor/getmytiffins')
    ...
    backgroundAttachment:'fixed', content:"",position:'fixed',width:'100%',height:'100%',zIndex:-1,opacity:0.5}}></div>
        ...
        <div>
          <center><button className="btn btn-success btn-lg" onClick={add}>Add new tiffin</button></center>
          </div>
