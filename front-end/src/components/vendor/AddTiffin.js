...
function AddTiffin() {
    ...
    const handleCategoryChange = (event) => {
      ...
      {
        debugger;
        var tiffin = {"tiffin_name": tiffinName, "description": description,
...
"image_link": image}
        ...
        const url = createaUrl('vendor/addtiffin')
...
<center>
    ...
    <label clasName="form-check-label mx-3" for="flexRadioDefault2">
        <h4 className="mx-3">Non-veg</h4>
          ...
          <center>
            <button className="btn btn-primary btn-lg my-3" onClick={addtiffin}>Add Tiffin</button>
            </center>
                </div>
                <div className="col-md-3"></div>
            </div>
