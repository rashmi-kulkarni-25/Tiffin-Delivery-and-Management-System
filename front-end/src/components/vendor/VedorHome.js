...
function VendorHome() {
  ...
  var vendorId = sessionStorage.getItem("vendorId");
    ...
    const [order, setOrder] = useState({order_id:0, name:"", home_address:"", 
      work_address:"", vendor_name:"", tiffin_name:"", quantity:0})
  ...
  // {
  //   debugger
  //   const url = createUrl('api/vendors/myorders')
  //   axios.post(url,
  //     {
  //       vendorId
  //     })
  ...
  const getMyOrders = () =>
  {
      ...
      const url = createaUrl('vendor/getmyorders')
...
<div className="col-md-8">
        ...
        <h2 style={{textAlign:'center', marginTop:'15px', padding:'10px'}}>Orders</h2>
        </div>
