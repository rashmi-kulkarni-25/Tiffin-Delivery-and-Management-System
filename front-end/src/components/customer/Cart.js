        ...
        <div className='col-md-8'>
{
    ...
    <div className='container mt-3'>
      <div className="border border-4 p-3 bg-dark text-light">
        <div className='row' style={{height:'200px'}}>
          ...
          <div><h5>{tiffin.description}</h5></div>
          <button className="btn btn-danger" onClick={()=> remove(tiffin.cart_id)}>Remove</button>
          </div>
          ...
          <div className='col-md-2' style={{marginTop:'70px'}}>
            <h1>₹ {`${tiffin.tiffin_price*tiffin.quantity}`}</h1>
            </div>
        ...
        <div className='col-md-4'>
          <div className='container mt-3 mx-3 my-3' style={{padding:'15px'}}>
            <div className="border border-4 p-3" style={{backgroundColor:'olivedrab', color:'white'}} >
        ...
        <div>
          <div className="form-check">
            <div className="container my-3">
              <label> <h5>Cardholder's Name </h5></label>
           <input className="form-control my-3" placeholder="Cardholder's name" type="text" style={{height:'50px'}}></input>
           <label><h5>Card Number</h5></label>
           <input className="form-control my-3" placeholder="Card Number" type="text" style={{height:'50px'}}></input>
  ...
  <div className="form-check">
          ...
          <center>
                  ...
                  <div className="border border-2 p-3" style={{width:"200px"}}><h2>₹ {total}</h2></div>
          </center>
          <hr></hr>
        <center>
          <button type="button" className="btn btn-primary mx-3"
          onClick={getCartTotal}><b>Calculate total</b></button>
          <button type="button" className="btn btn-primary mx-3"
          onClick={placeorder}><b>Place Order</b></button>
        </center>
        </div>
        </div>
          </div>
